...
namespace ProgChallenge
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Checking balance is {checking._balance:C2}");
            Console.WriteLine($"Savings balance is {saving._balance:C2}");

            // Print the account owner information. Expected output: 
            // "Checking owner: John Doe"
            // "Savings owner: Jane Doe"
            Console.WriteLine($"Checking owner: {checking._name} {checking._surname}");
            Console.WriteLine($"Savings owner: {saving._name} {saving._surname}");
